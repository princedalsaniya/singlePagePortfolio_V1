      ...
      <div className="container">
        ...
        <div className="flex flex-col mt-10 gap-20">
          {portfolioProjects.map((project) => (
            <div
              className="bg-gray-800 rounded-3xl relative z-0 overflow-hidden after:content-[''] after:absolute after:inset-0 after:z-10 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 px-8 pt-8 after:pointer-events-none"
              key={project.title}
            >
              <div
              ...
              <Image className="mt-8 -mb-4" src={project.image} alt={project.title}></Image>
            </div>
          ))}
        </div>
      </div>
